...
const CreacionProveedor = () => {
  ...
  const validateCompleteForm = useCallback(
    (validarDocumentos = false) => {
      ...
      // Validaciones de los nuevos campos de contacto SOLO para persona jurídica
      if (isPersonaJuridica) {
        // CARTERA
        ...
        if (!formData.contacto_tesoreria_email?.trim()) {
          errors.contacto_tesoreria_email =
            "Email contacto Tesorería requerido";
    ...
    <form onSubmit={handleFormSubmit} className="tc-form">
      ...
      {pasoActual === 1 && (
        <>
          ...
          {formData.tipo_regimen === "persona_juridica" && (
            <>
              {/* CONTACTO CARTERA */}
              <div className="tc-form-separator">
              ...
              <div className="tc-form-grid grid-3-cols">
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_cartera_nombre ? "is-invalid" : ""
                    }`}
                  />
                ...
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_cartera_email ? "is-invalid" : ""
                    }`}
                  />
                ...
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_cartera_telefono ? "is-invalid" : ""
                    }`}
                  />
              ...
              <div className="tc-form-grid grid-3-cols">
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_tesoreria_nombre ? "is-invalid" : ""
                    }`}
                  />
                ...
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_tesoreria_email ? "is-invalid" : ""
                    }`}
                  />
                ...
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_tesoreria_telefono ? "is-invalid" : ""
                    }`}
                  />
              ...
              <div className="tc-form-grid grid-3-cols">
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_compras_nombre ? "is-invalid" : ""
                    }`}
                  />
                ...
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_compras_email ? "is-invalid" : ""
                    }`}
                  />
                ...
                <div className="tc-form-group">
                  ...
                  <input
                    ...
                    onChange={handleFieldChange}
                    className={`tc-form-input ${
                      formErrors.contacto_compras_telefono ? "is-invalid" : ""
                    }`}
                  />
