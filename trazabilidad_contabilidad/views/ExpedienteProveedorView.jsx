...
const ExpedienteProveedorView = ({
  ...
  if (proveedor) {
    if (userRole === "admin_tesoreria") {
      ...
      if (
        proveedor.registra_en_bolsa === "si" ||
        proveedor.url_certificado_bolsa
      ) {
      ...
      <div className="expediente-container-inner">
        ...
        {proveedor && (
          <>
            ...
            <div className="expediente-info-card">
              ...
              <div className="info-card-grid">
                ...
                <InfoItem
                  ...
                  value={proveedor.condicion_pago}
                />
                <InfoItem
                  label="Registra en Bolsa"
                  value={proveedor.registra_en_bolsa}
                />
                <InfoItem
                ...
                <InfoItem
                  label="Federaciones"
                  value={proveedor.federaciones_recaudo}
                />
              </div>
            </div>
            ...
            <div className="expediente-info-card">
              <h2 className="info-card-title">Ubicación y Facturación</h2>
              <div className="info-card-grid">
                <InfoItem
            ...
            {/* TARJETA DE CONTACTOS POR ÁREA */}
            <div className="expediente-info-card">
              <h2 className="info-card-title">Contactos por Área</h2>
              <div
              ...
              >
                ...
                >
                  ...
                  <InfoItem
                    label="Nombre"
                    value={proveedor.contacto_cartera_nombre}
                  />
                  <InfoItem
                    label="Email"
                    value={proveedor.contacto_cartera_email}
                  />
                  <InfoItem
                    label="Teléfono"
                    value={proveedor.contacto_cartera_telefono}
                  />
                </div>
                {/* Tesorería */}
                <div
                ...
                >
                  ...
                  <InfoItem
                    label="Nombre"
                    value={proveedor.contacto_tesoreria_nombre}
                  />
                  <InfoItem
                    label="Email"
                    value={proveedor.contacto_tesoreria_email}
                  />
                  <InfoItem
                    label="Teléfono"
                    value={proveedor.contacto_tesoreria_telefono}
                  />
                </div>
                {/* Compras */}
                <div
                ...
                >
                  ...
                  <InfoItem
                    label="Nombre"
                    value={proveedor.contacto_compras_nombre}
                  />
                  <InfoItem
                    label="Email"
                    value={proveedor.contacto_compras_email}
                  />
                  <InfoItem
                    label="Teléfono"
                    value={proveedor.contacto_compras_telefono}
                  />
                </div>
              </div>
            </div>
