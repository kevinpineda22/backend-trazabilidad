                ...
                <tbody>
                    {historial.map(prov => (
                        <tr key={prov.id}>
                            ...
                            <td className="admin-cont-cell-centered">{format(parseISO(prov.created_at), 'dd/MM/yy hh:mm a')}</td>
                            <td className="admin-cont-doc-cell admin-cont-cell-centered">
                                <AdminDocLink url={prov.url_rut} label="RUT" onPreview={onPreview} />
                            </td>
                            <td className="admin-cont-doc-cell admin-cont-cell-centered">
                                <AdminDocLink url={prov.url_camara_comercio} label="Cám. Comercio" onPreview={onPreview} />
                            </td>
                            <td className="admin-cont-doc-cell admin-cont-cell-centered">
                                {/* --- ¡AQUÍ ESTABA EL ERROR! Corregido de 'onV' a 'onPreview' --- */}
                                <AdminDocLink url={prov.url_certificacion_bancaria} label="Cert. Bancaria" onPreview={onPreview} />
                            </td>
                            <td className="admin-cont-doc-cell admin-cont-cell-centered">
                                <AdminDocLink url={prov.url_formato_vinculacion} label="Vinculación" onPreview={onPreview} />
                            </td>
                            <td className="admin-cont-doc-cell admin-cont-cell-centered">
                                <AdminDocLink url={prov.url_composicion_accionaria} label="Comp. Accionaria" onPreview={onPreview} />
                            </td>
                        </tr>
                    ))}
                </tbody>
